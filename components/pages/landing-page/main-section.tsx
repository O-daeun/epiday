...
export default function MainSection() {
  return (
    <main className="relative flex h-screen min-h-[530px] flex-col items-center justify-center bg-[repeating-linear-gradient(white,white_25px,#F2F2F2_27px)] pb-20 sm:bg-[repeating-linear-gradient(white,white_35px,#F2F2F2_37px)]">
